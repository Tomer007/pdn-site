            ...
            <FadeInView key={i} delay={i * 0.1}>
              <div className="rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="p-3 bg-white">
                  <p className="text-sm font-bold truncate">{video.title[locale]}</p>
                </div>
              </div>
            </FadeInView>
          ))}
        ...
        <FadeInView delay={0.3}>
          <div className="bg-white rounded-2xl border border-border p-6 sm:p-8">
            <h3 className="font-display font-bold text-lg text-center mb-6">
              {locale === "he" ? "עוד תוכן ב..." : "More Content On..."}
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <a
                ...
                className="flex items-center gap-3 p-4 rounded-xl bg-red-50 border border-red-100 hover:shadow-md transition-all group"
              >
                ...
                <div>
                  <p className="font-bold text-sm group-hover:text-red-600 transition-colors">YouTube</p>
                  <p className="text-xs text-text-secondary">{locale === "he" ? "סרטונים ושיעורים" : "Videos & Lessons"}</p>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-4 rounded-xl bg-blue-50 border border-blue-100 hover:shadow-md transition-all group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-4 rounded-xl bg-purple-50 border border-purple-100 hover:shadow-md transition-all group"
              >
                ...
                <div>
                  <p className="font-bold text-sm group-hover:text-purple-600 transition-colors">{locale === "he" ? "פודקאסט" : "Podcast"}</p>
                  <p className="text-xs text-text-secondary">{locale === "he" ? "שיחות על תודעה והצלחה" : "Conversations on consciousness"}</p>
                </div>
              </a>
            </div>
          </div>
